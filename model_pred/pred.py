...
def go(args):
    ...
    logger.info("Downloading and reading the exported model_train")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Test the provided model_train on the test artifact",
    ...
    parser.add_argument(
        "--model_export",
        type=str,
        help="Fully-qualified artifact name for the exported model_train to model_pred",
        required=True,
    )
